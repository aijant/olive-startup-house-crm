...
export default function PropertiesPage() {
  ...
  const showDeleteComms = canViewCommunityAdminProfiles && isDevBuild();
        ...
        >
          ...
          >
            <DialogHeader>
              ...
              <DialogDescription>
                This removes Communication Center data for the address you enter. This cannot be undone. Development
                builds only.
              </DialogDescription>
            </DialogHeader>
